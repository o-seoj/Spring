...
class User1MapperTest {
    ...
    void insert() {
        ...
        // Then - 테스트 결과를 검증
        User1DTO savedUser = user1Mapper.select(user1DTO.getUids());
        assertEquals(user1DTO.getUids(), savedUser.getUids());
    }
    ...
    void select() {
        ...
        assertEquals(findUser.getUids(), userid);
    }
    ...
    void selectAll() {
        // When
        java.util.List<User1DTO> dtoList = user1Mapper.selectAll();
    ...
    void update() {
        ...
        // Then
        User1DTO modifiedUser = user1Mapper.select(user1DTO.getUids());
