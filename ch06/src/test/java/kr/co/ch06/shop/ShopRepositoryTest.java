...
import kr.co.ch06.repository.CustomerRepository;
...
public class ShopRepositoryTest {
    ...
    @Test
    public void test1(){
        Customer customer = customerRepostory.selectCustomer("a105");
        System.out.println(customer);
    }

    @Test
    public void test2(){
        List<Customer> customerList = customerRepostory.selectAllCustomer();
        System.out.println(customerList);
    }

    @Test
    public void test3(){
        List<Customer> customerList = customerRepostory.selectProjectionCustomer();
        System.out.println(customerList);
    }
    ...
    @Test
    public void test9(){
        kr.co.ch06.dto.ProductAggDto resultDTO = queryFactory.select(
                Projections.fields(
                        ProductAggDto.class,
